        ...
        >
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 bg-[#050505] border border-[#1A1A1A] rounded-lg text-[#EDEDED] focus:outline-none focus:border-[#00D9FF] transition-colors">
            ...
            <button
              type="submit"
              className="w-full px-10 py-5 bg-gradient-to-r from-[#00D9FF] to-[#00FF88] text-black font-bold rounded-lg hover:opacity-90 transition-opacity text-lg"
            >
